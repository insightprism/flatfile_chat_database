...
from flatfile_chat_database.prismmind_integration.config import FlatfilePrismMindConfig


class FlatfilePrismMindConfigFactory:
    ...
    def create_complete_processing_chain(
        ...
        for engine_name in processing_chain:
            if engine_name == "pm_injest_engine":
                ...
                engine_config, handler_config = FlatfilePrismMindConfigFactory.create_injest_engine_config(
                    file_type, config
                )
                ...
                # Create NLP engine
                engine_config = FlatfilePrismMindConfigFactory.create_nlp_engine_config(
                ...
                engine_config, handler_config = FlatfilePrismMindConfigFactory.create_chunking_engine_config(
                ...
                engine_config, handler_config = FlatfilePrismMindConfigFactory.create_standard_embedding_engine_config(
                ...
                engine_config, handler_config = FlatfilePrismMindConfigFactory.create_embedding_engine_config_with_storage(
    ...
    @staticmethod
    def validate_configuration(config: FlatfilePrismMindConfig) -> List[str]:
        """
