...
class FlatfileBackend(StorageBackend):
    ...
    async def initialize(self) -> bool:
        ...
        """
        try:
            await ensure_directory(self.base_path)
            ...
            for subdir in subdirs:
                await ensure_directory(self.base_path / subdir)
    ...
    async def write(self, key: str, data: bytes) -> bool:
        ...
        """
        path = self._get_absolute_path(key)
        return await atomic_write(path, data, self.config, mode='wb')
    ...
    async def delete(self, key: str) -> bool:
        ...
        return await safe_delete(path, self.config, backup_callback)
    ...
    async def list_keys(self, prefix: str, pattern: Optional[str] = None) -> List[str]:
        ...
        files = await list_files(prefix_path, glob_pattern, recursive=True)
    ...
    async def get_size(self, key: str) -> int:
        ...
        """
        path = self._get_absolute_path(key)
        return await get_file_size(path)
